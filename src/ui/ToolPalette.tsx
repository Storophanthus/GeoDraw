...
export const TOOL_REGISTRY: Record<ActiveTool, ToolDef> = {
  ...
  ray: { icon: IconRay, tooltip: "Ray Through 2 Points", ariaLabel: "Ray tool" },
...
const TOOL_GROUPS: Array<{ id: ToolGroupId; label: string; tools: ActiveTool[] }> = [
  ...
  { id: "lines", label: "LINES", tools: ["segment", "ray", "line2p", "perp_line", "parallel_line", "tangent_line", "angle_bisector"] },
