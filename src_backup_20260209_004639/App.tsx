...
const TOOL_REGISTRY: Record<ActiveTool, ToolDef> = {
  ...
  midpoint: { icon: Dot, tooltip: "Midpoint (M)", ariaLabel: "Midpoint tool" },
...
const TOOL_GROUPS: Array<{ id: ToolGroupId; label: string; tools: ActiveTool[] }> = [
  { id: "points", label: "POINTS", tools: ["move", "point", "midpoint"] },
...
export default function App() {
  ...
  }, [deleteSelectedObject, openFlyoutGroup]);
          ...
          <>
            ...
            <section className="sidebarSection">
              ...
              <div className="objectList">
                {scene.points.length === 0 && <div className="emptyState">No points</div>}
                {scene.points.map((point) => (
                  <button
                    key={point.id}
                    className={point.id === selectedPointId ? "objectItem active" : "objectItem"}
            ...
            <section className="sidebarSection">
              ...
              {!selectedPoint && <div className="emptyState">Select a point to edit point properties</div>}
              {selectedPoint && (
                <>
