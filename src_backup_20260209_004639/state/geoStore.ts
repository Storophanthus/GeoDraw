...
export type ActiveTool = "move" | "point" | "midpoint" | "segment" | "line2p";
    ...
    setState((prev) => {
      ...
      if (prev.selectedObject.type === "point") {
        ...
        return {
          ...
          scene: {
            ...prev.scene,
            points: prev.scene.points.filter((point) => {
      ...
      if (prev.selectedObject.type === "segment") {
        ...
        return {
          ...
          scene: {
            ...prev.scene,
            segments: prev.scene.segments.filter((seg) => seg.id !== segId),
