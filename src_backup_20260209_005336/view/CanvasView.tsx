...
export function CanvasView() {
  ...
  const draw = useMemo(
    ...
    [camera, copyStyle.source, dpr, pendingTool, resolvedPoints, scene, selectedObject, vp]
  );
...
function handleToolClick(
  ...
  hits: {
    ...
    hitObject: { type: "point" | "segment" | "line"; id: string } | null;
    shiftKey: boolean;
  ...
  io: {
    ...
    setCopyStyleSource: (obj: { type: "point" | "segment" | "line"; id: string }) => void;
    applyCopyStyleTo: (obj: { type: "point" | "segment" | "line"; id: string }) => void;
    camera: Camera;
    vp: Viewport;
  }
) {
...
function hitTestTopObject(
  ...
  camera: Camera,
  vp: Viewport
): { type: "point" | "segment" | "line"; id: string } | null {
...
function drawLines(
  ...
  copySource: { type: "point" | "segment" | "line"; id: string } | null
) {
  ctx.save();
